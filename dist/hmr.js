...
const ws = new WebSocket(`ws://localhost:${window.__hmrServerPort}`);
...
function handleWarnings(event) {
    console.warn(`[hmrServer] Error: can't properly monitor changes in the following paths ${JSON.stringify(event.paths)}, changes in this files will cause full-reload`);
}
